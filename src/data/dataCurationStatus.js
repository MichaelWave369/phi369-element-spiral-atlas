export const DATA_CURATION_STATUS = {
  ...
  fields: {
    ...
    electronConfiguration: { status: "limited-seed-batch-2", sourceIds: ["rsc", "pubchem"], notes: "v2.7 expands electron configurations through element 36 (Kr); remaining elements stay null until future curated batches." },
